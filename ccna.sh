...
if [ $rand = 15 ]; then
    ...
    input "Router#" "configure terminal"
    c "Enter configuration commands, one per line. End with CNTL/Z."
    input "Router(config)#" "hostname BR1"
    i "Configure gigabitEthernet 0/0/0 with an ip of"
    i "192.168.33.249 and a hostmask of 255.255.255.252"
    input "BR1(config)#" "interface gigabitEthernet 0/0/0"
    input "BR1(config-if)#" "ip address 192.168.33.249 255.255.255.252"
    i "Configure interface gigabitEthernet 0/0/1 with an ip of 192.168.33.129 and a hostmask of 255.255.255.192"
    input "BR1(config-if)#" "interface gigabitEthernet 0/0/1"
    input "BR1(config-if)#" "ip address 192.168.33.129 255.255.255.192"
    i "Configure both interfaces so that they are up"
    input "BR1(config-if)#" "interface gigabitEthernet 0/0/0"
    input "BR1(config-if)#" "no shutdown"
    input "BR1(config-if)#" "interface gigabitEthernet 0/0/1"
    input "BR1(config-if)#" "no shutdown"
    i "Exit out of configuration mode and ping 192.168.33.129"
    input "BR1(config-if)#" "exit"
    input "BR1(config)#" "exit"
    input "BR1#" "ping 192.168.33.250"
...
if [ $rand = 16 ]; then
    ...
    input "Router#" "configure terminal"
    c "Enter configuration commands, one per line. End with CNTL/Z."
    input "Router(config)#" "hostname BR2"
    i "Configure gigabitEthernet 0/0/0 with an ip of"
    i "192.168.33.250 and a hostmask of 255.255.255.252"
    input "BR2(config)#" "interface gigabitEthernet 0/0/0"
    input "BR2(config-if)#" "ip address 192.168.33.250 255.255.255.252"
    i "Configure interface gigabitEthernet 0/0/1 with an ip of 192.168.33.193 and a hostmask of 255.255.255.224"
    input "BR2(config-if)#" "interface gigabitEthernet 0/0/1"
    input "BR2(config-if)#" "ip address 192.168.33.193 255.255.255.224"
    i "Configure both interfaces so that they are up"
    input "BR2(config-if)#" "interface gigabitEthernet 0/0/0"
    input "BR2(config-if)#" "no shutdown"
    input "BR2(config-if)#" "interface gigabitEthernet 0/0/1"
    input "BR2(config-if)#" "no shutdown"
    i "Exit out of configuration mode and ping 192.168.33.249"
    input "BR2(config-if)#" "exit"
    input "BR2(config)#" "exit"
    input "BR2#" "ping 192.168.33.249"
